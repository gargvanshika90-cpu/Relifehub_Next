...
export default function OthersPage() {
  ...
  return (
    ...
    <main className="min-h-screen bg-[#fffaf5]">
      ...
      <section className="bg-gradient-to-r from-orange-50 via-amber-50 to-rose-50">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-gray-600 mt-6">
                Discover useful everyday items ready for a new home.
              </p>

              <p className="text-lg text-gray-500 mt-2">
                Reuse useful products, save money,
            ...
            <div>
              <Image
                src="/others/banner.png"
                alt="Other useful products"
                width={700}
                height={500}
      ...
      <section className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {products.map((item) => (
            <div
              key={item.id}
              className="bg-white rounded-2xl shadow border border-[#f1dfd0] hover:shadow-xl transition overflow-hidden group"
            >
              {/* IMAGE */}
              ...
              <div className="relative p-6 bg-[#fffaf5]">
                ...
                <Link
                  href={`/categories/others/details?id=${item.id}`}
                  className="block"
                >
                  <Image
                    src={item.image}
              ...
              <div className="px-6 pb-6">
                ...
                <div className="grid grid-cols-2 gap-3 mt-6">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 border-2 border-orange-600 text-orange-600 py-3 rounded-xl hover:bg-orange-200 hover:text-white duration-300"
                  >
                  ...
                  <Link
                    href={`/categories/others/details?id=${item.id}`}
                    className="flex items-center justify-center gap-2 bg-orange-600 text-white py-3 rounded-xl text-sm font-semibold hover:bg-orange-700 duration-300"
                  >
                    Buy Now
                  </Link>
                </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-10">
        <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl">
